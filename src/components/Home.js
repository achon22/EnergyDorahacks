          ...
          <Content style={{ padding: '0 50px' }}>
            ...
            <Layout style={{ padding: '24px 0', background: '#fff' }}>
              ...
              <Content style={{ padding: '0 24px', minHeight: 280 }}>
                ...
                <h4> What's more? </h4>
                <p> We use a state-of-the-art, proprietary MCFT token technology to tranfer energy resources from one owner to the next. </p>
                <p>Solar is the new gas. Are you ready for the revolution?</p>
                <Row gutter={16}>
                  <Col span={8}>
